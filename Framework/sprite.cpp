...
void
Sprite::DrawSmaller(BackBuffer& backbuffer)
{
	backbuffer.DrawSmaller(*this);
}

void
Sprite::Rotate(BackBuffer& backbuffer, double angle, SDL_RendererFlip fl)
{
	backbuffer.RotateSprite(*this, angle, fl);
}
